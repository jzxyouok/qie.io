...
<div class="sidebar">
  <div class="wrap">
    ...
    <nav class="nav">
      <ul>
        <li class="parent" data-active-url="^<{$dir}>(?:/(?:index\.php(?:/(?:(?:main|setting|phpinfo)/)?)?)?)?$"><a href="#" title="网站设定"><i class="fa fa-dashboard"></i>网站设定<span class="fa arrow"></span></a>
          <ul>
            <li><a href="<{$dir}>/index.php/main/" title="修改密码">修改密码</a></li>
            <li><a href="<{$dir}>/index.php/setting/" title="系统设定">系统设定</a></li>
            <li><a href="<{$dir}>/index.php/phpinfo/" title="phpinfo">phpinfo</a></li>
          </ul>
        </li>
