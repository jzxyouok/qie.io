    ...
    <div class="panel default-form">
      ...
      <div class="body">
        ...
        <div class="input-group">
          ...
          <div class="control"><input type="text" name="user_name" placeholder="请输入用户名" autofocus value="<{$data.name}>"></div>
          </label>
        </div>
        <div class="input-group">
          <label>
          <div class="title">密&nbsp; &nbsp; &nbsp; 码:</div>
          <div class="control"><input type="text" name="pwd" placeholder="请输入密码"></div>
          </label>
        </div>
        <div class="input-group">
          <label>
          <div class="title">电子邮箱:</div>
          <div class="control"><input type="text" name="email" placeholder="请输入电子邮箱" value="<{$data.email}>"></div>
          </label>
        </div>
        <div class="input-group">
          <label>
