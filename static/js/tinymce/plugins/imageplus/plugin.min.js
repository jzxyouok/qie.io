tinymce.PluginManager.add("imageplus", function(a) {
    ...
    function e(d) {
        ...
        function insertImage(data) {
            ...
            for(var i = 0; i < data.result.length; i++) {
                html += '<li src="'+data.result[i].path+'"><img src="'+data.result[i].path+'" onerror="this.error = null; var parent = this.parentNode; parent.removeChild(this);parent.innerHTML=\'error\'"></li>';
            }
            footHtml = (data.current <= 1?'<span>|&lt;</span><span>&lt;</span>':'<a class="page-num" data-page-num="1" href="javascript:void(0);">|&lt;</a><a class="page-num" data-page-num="'+(data.current-1)+'" href="javascript:void(0);">&lt;</a>')+(data.current >= data.max?'<span>&gt;</span><span>&gt;|</span>':'<a class="page-num" data-page-num="'+(data.current+1)+'" href="javascript:void(0);">&gt;</a><a class="page-num" data-page-num="'+(data.max)+'" href="javascript:void(0);">&gt;|</a>');
            listBody.html('<div class="mce-image-plus-body" style="height:'+(bodyHeight-35)+'px;"><div><ul class="clearfix">'+html+'</ul></div></div><div class="mce-image-plus-footer mce-abs-layout-item">'+footHtml+'</div></div>');
        }
        if(a.settings.image_advtab) {
            ...
            listBody.addClass('mce-image-plus').on('click', function(e){
    ...
    a.on("preInit", function() {
        ...
        //console.log(a)
        //a.dom.styleSheetLoader.load('/static/js/tinymce/plugins/imageplus/image-plus.css');
